...
public abstract class ProdottoDaoConVerifiche<T> extends Dao implements IProdottoDao {
	...
	protected final IProdottoDaoBase<T> daoProdotti;
	
	protected final Integer commessa;

	public ProdottoDaoConVerifiche(String persistenceUnit, Integer idCommessa) {
	...
	protected abstract IProdottoDaoBase<T> getDaoProdotti(String persistenceUnit);
