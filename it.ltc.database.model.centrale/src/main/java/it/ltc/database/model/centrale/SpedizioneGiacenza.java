...
public class SpedizioneGiacenza implements Serializable, Comparable<SpedizioneGiacenza> {
...
//	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SpedizioneGiacenza other = (SpedizioneGiacenza) obj;
		if (id != other.id)
			return false;
		return true;
	}
	
	public int compareTo(SpedizioneGiacenza giacenza) {
