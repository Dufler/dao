...
/**
 * The persistent class for the listino_corriere_voce_percentuale database table.
 * 
 */
@Entity
@Table(name="listino_corriere_voce_percentuale")
@NamedQuery(name="ListinoCorriereVocePercentuale.findAll", query="SELECT l FROM ListinoCorriereVocePercentuale l")
public class ListinoCorriereVocePercentuale implements Serializable {
	...
	public ListinoCorriereVocePercentuale() {
	}
